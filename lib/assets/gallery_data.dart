...
List<GalleryItem> galleryData = [
  GalleryItem(
    ...
    imagePath: 'lib/assets/images/basketball_1.jpeg',
  ),
  GalleryItem(
    ...
    imagePath: 'lib/assets/images/ski.jpeg',
  ),
  GalleryItem(
    ...
    imagePath: 'lib/assets/images/bike.jpeg',
  ),
  GalleryItem(
    ...
    imagePath: 'lib/assets/images/running.jpeg',
  ),
  GalleryItem(
    imageTitle: 'Swish',
    ...
    imagePath: 'lib/assets/images/basketball_2.jpeg',
  ),
  GalleryItem(
    ...
    imagePath: 'lib/assets/images/tennis_1.jpeg',
  ),
  GalleryItem(
    ...
    imagePath: 'lib/assets/images/tennis_2.jpeg',
  ),
  GalleryItem(
    imageTitle: 'Kaya',
    imageDate: '01.01.2021',
    imageDescription:
        'Ein weiteres Beispielbild.',
    imagePath: 'lib/assets/images/kaya.jpeg',
  ),
  GalleryItem(
    imageTitle: 'Soccer',
    imageDate: '01.01.2021',
    imageDescription:
        'Ein weiteres Beispielbild.',
    imagePath: 'lib/assets/images/soccer.jpeg',
  ),
];
